...
for epoch in range(1, n_epochs + 1):
    ...
    algaater_1 = AlegAATr('Algaater1', prisoners_game, algaater_idx_1, baselines, use_auto_aat=use_auto_aat)
    algaater_2 = AlegAATr('Algaater2', prisoners_game, algaater_idx_2, baselines, use_auto_aat=use_auto_aat)
    ...
    for round_num in range(n_rounds):
        ...
        for agent_key, agent in key_agent_map.items():
            ...
            new_assumptions = agent.update_expert(prev_rewards, prev_opp_rewards,
                                                                     ...
                                                                     agent_reward, n_remaining_rounds, state, r1, r2, ACTIONS)
...
compressed_rewards_df.to_csv(f'../../analysis/{str(prisoners_game)}/algaater_self_play{file_modifier}.csv')
...
plt.savefig(f'../simulations/{str(prisoners_game)}/algaater_self_play{file_modifier}.png', bbox_inches='tight')
plt.clf()
