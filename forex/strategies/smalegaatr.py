...
from utils.utils import FOREX_E_DESCRIPTION, FOREX_G_DESCRIPTIONS, PAD_VAL
...
class SMAlegAATr(Strategy):
    def __init__(self, name: str = 'SMAlegAATr', starting_idx: int = 2, percent_to_risk: float = 0.02,
    ...
    def place_trade(self, curr_idx: int, strategy_data: DataFrame, currency_pair: str, account_balance: float) -> \
        ...
        best_desc = FOREX_G_DESCRIPTIONS[self.generator_in_use_name]
