...
compressed_rewards_df.to_csv(f'../../analysis/{str(prisoners_game)}/algaater_vs_spp_algaater{file_modifier}.csv')

compressed_rewards_df_opp = pd.DataFrame(vals_2, columns=['S++'])
compressed_rewards_df_opp.to_csv(f'../../analysis/{str(prisoners_game)}/algaater_vs_spp_spp{file_modifier}.csv')
...
plt.savefig(f'../simulations/{str(prisoners_game)}/algaater_vs_spp{file_modifier}.png', bbox_inches='tight')
plt.clf()
